...
--
-- Host: 127.0.0.1    Database: node_acc_log
-- ------------------------------------------------------
...
CREATE TABLE `query_log` (
  ...
  `uid` varchar(255) NOT NULL DEFAULT '__NA__',
...
--
-- Table structure for table `server_ap_log`
--

DROP TABLE IF EXISTS `server_ap_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `server_ap_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `server_ap_log`
--

LOCK TABLES `server_ap_log` WRITE;
/*!40000 ALTER TABLE `server_ap_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `server_ap_log` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-04-15 20:46:56
